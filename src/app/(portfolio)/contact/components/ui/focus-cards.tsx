...
import {
  ...
  DialogTitle,
  DialogTrigger,
} from "@/app/(portfolio)/contact/components/ui/dialog"
    ...
    <Dialog>
      ...
      <DialogContent className="h-[90%]">
        ...
        >
          ...
          >
            <DialogHeader className="text-xl md:text-2xl font-medium bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-200 gap-6">
